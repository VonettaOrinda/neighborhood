    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbourhood_location', models.CharField(blank=True, choices=[('Kawangware', 'Kawangware'), ('Umoja', 'Umoja'), ('Buruburu', 'Buruburu'), ('Kilimani', 'Kilimani'), ('Kileleshwa', 'Kileleshwa'), ('Runda', 'Runda'), ('Imara Daima', 'Imara Daima'), ('Syokimau', 'Syokimau'), ('Riverside drive', 'Riverside drive'), ('Ruaka', 'Ruaka')], default=0, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('neighbourhood', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhoodproject', to='hood.neighbourhood')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='hood.image')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='hood.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbourhood_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhood', to='hood.neighbourhood')),
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='hood.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('neighbourhood_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhoodjoin', to='hood.neighbourhood')),
        ...
        migrations.AddField(
            model_name='image',
            name='tags',
            field=models.ManyToManyField(blank=True, to='hood.tags'),
        ),
        migrations.AddField(
            model_name='image',
            name='user',
